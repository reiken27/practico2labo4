...
import 'package:practico2labo4/widgets/pokemon_list_item.dart';
                      ...
                      Column(
                        children: ability?.pokemon?.map((pokemon) {
                              ...
                              return PokemonListItem(
                                ...
                                imageUrl: imageUrl,
                                isHiddenAbility: pokemon.isHidden ?? false,
                                isTapped: tappedPokemonId == pokemonId,
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                ...
                                onTapDown: () =>
                                    setState(() => tappedPokemonId = pokemonId),
                                onTapUp: () =>
                                    setState(() => tappedPokemonId = null),
                                onTapCancel: () =>
                                    setState(() => tappedPokemonId = null),
                              );
                            }).toList() ??
