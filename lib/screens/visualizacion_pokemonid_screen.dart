...
class _VisualizacionPokemonidScreenState
    ...
    if (speciesResponse.statusCode == 200) {
      ...
      if (evolutionUrl != null) {
        ...
        if (evolutionResponse.statusCode == 200) {
          setState(() {
            evolutionChain = ModelEvolutionChain.fromJson(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DetailRowWidget(
                              title: 'Tipo', value: getPokemonTypes()),
                          DetailRowWidget(
                              title: 'Habilidades',
                              value: getPokemonAbilities()),
                        ],
                      ),
                    ),
                    const SizedBox(height: 20),
                    ...
                    StatBarWidget(
                        label: 'HP',
                        value: pokemon!.stats?[0].baseStat ?? 0,
                        maxStat: 100),
                    StatBarWidget(
                        label: 'ATK',
                        value: pokemon!.stats!.length > 1
                            ? pokemon!.stats![1].baseStat ?? 0
                            : 0,
                        maxStat: 100),
                    StatBarWidget(
                        label: 'DEF',
                        value: pokemon!.stats!.length > 2
                            ? pokemon!.stats![2].baseStat ?? 0
                            : 0,
                        maxStat: 100),
                    StatBarWidget(
                      label: 'SPD',
  ...
  String getPokemonTypes() {
    if (pokemon?.types != null && pokemon!.types!.isNotEmpty) {
      return pokemon!.types!.map((type) => type.type?.name ?? 'N/A').join(', ');
    }
    return 'N/A';
  }
